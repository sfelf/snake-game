...
class TestSnakeBodyRenderer:
    ...
    @patch('pygame.time.get_ticks')
    def test_draw_body_multiple_points(self, mock_ticks, mock_circle, mock_line, renderer):
...
class TestSnakeHeadRenderer:
    ...
    @patch('pygame.draw.line')
    @patch('pygame.time.get_ticks')
    def test_draw_head_right_direction(self, mock_ticks, mock_line, mock_circle, mock_ellipse, renderer):
