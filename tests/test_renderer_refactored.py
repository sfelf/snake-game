...
from snake_game.models import Snake, Direction
...
class TestGameRendererRefactored:
    ...
    def test_draw_snake_single_segment(self, renderer):
        ...
        renderer.snake_head_renderer.draw_head.assert_called_once_with(5, 5, Direction.RIGHT)
        renderer.snake_body_renderer.draw_body.assert_not_called()
        renderer.snake_scale_renderer.draw_scales.assert_not_called()
    
    @patch('snake_game.utils.path_smoother.PathSmoother.convert_segments_to_screen_points')
    @patch('snake_game.utils.path_smoother.PathSmoother.create_smooth_path')
    def test_draw_snake_multiple_segments(self, mock_smooth_path, mock_convert, renderer):
        ...
        renderer.snake_body_renderer.draw_body.assert_called_once_with(mock_smooth_points, snake.segments)
        renderer.snake_scale_renderer.draw_scales.assert_called_once_with(mock_smooth_points)
        renderer.snake_head_renderer.draw_head.assert_called_once_with(5, 5, Direction.RIGHT)
    ...
    def test_component_renderer_integration(self, mock_screen):
        ...
        with patch('pygame.font.Font'):
            with patch.object(GameRenderer, '_ensure_images_loaded'):
                ...
                from snake_game.views.snake_renderer import SnakeBodyRenderer, SnakeHeadRenderer, SnakeScaleRenderer
    ...
    def test_separation_of_concerns(self, renderer):
        ...
        with patch('snake_game.utils.path_smoother.PathSmoother.convert_segments_to_screen_points') as mock_convert:
            with patch('snake_game.utils.path_smoother.PathSmoother.create_smooth_path') as mock_smooth:
                mock_convert.return_value = [(100, 100), (80, 100), (60, 100)]
                mock_smooth.return_value = [(100, 100), (90, 100), (80, 100), (70, 100), (60, 100)]
