...
class TestPathSmoother:
    ...
    def test_convert_segments_to_screen_points(self):
        ...
        for i, (grid_x, grid_y) in enumerate(segments):
            ...
            expected_x = GameConstants.PLAY_AREA_X + grid_x * GameConstants.CELL_SIZE + GameConstants.CELL_SIZE // 2
            expected_y = GameConstants.PLAY_AREA_Y + grid_y * GameConstants.CELL_SIZE + GameConstants.CELL_SIZE // 2
