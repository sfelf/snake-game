...
class TestGameConstants:
    ...
    def test_window_dimensions(self):
        ...
        expected_height = (
            30 * 20 + (2 * 2) + 60
        )  # grid_height * cell_size + borders + ui
    ...
    def test_play_area_dimensions(self):
        ...
        assert (
            ...
            == GameConstants.BORDER_WIDTH + GameConstants.UI_HEIGHT
        )
        assert (
            GameConstants.PLAY_AREA_WIDTH
            == GameConstants.GRID_WIDTH * GameConstants.CELL_SIZE
        )
        assert (
            GameConstants.PLAY_AREA_HEIGHT
            == GameConstants.GRID_HEIGHT * GameConstants.CELL_SIZE
        )
