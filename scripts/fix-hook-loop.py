...
def reinstall_hooks():
    ...
    try:
        subprocess.run(['poetry', 'run', 'python', 'scripts/setup-hooks.py'], check=True)
...
def main():
    ...
    if reinstall_hooks():
        ...
        print("💡 You may need to manually remove .git/hooks/pre-commit and .git/hooks/post-commit")
