...
class SnakeGame:
    ...
    def eat_fruit(self):
        ...
        self.speed = max(
            50, self.speed - self.SPEED_INCREASE
        ...
        if self.eat_sound:
            try:
                ...
                urgent_eat_sound = pygame.mixer.Sound(
                    buffer=self.generate_tone(440 * urgency_factor, 0.15)
                )
    ...
    def draw_border(self):
        ...
        border_rect = pygame.Rect(
            ...
            self.UI_HEIGHT,
            self.WINDOW_WIDTH,
            self.PLAY_AREA_HEIGHT + self.BORDER_WIDTH * 2,
        )
    ...
    def draw_ui(self):
        ...
        speed_text = self.small_font.render(
            f"Speed: {speed_percent}%", True, self.WHITE
        )
    ...
    def draw_game_over_screen(self):
        ...
        if self.score in self.high_scores[:5] and self.score > 0:
            ...
            high_score_rect = high_score_text.get_rect(
                center=(self.WINDOW_WIDTH // 2, 260)
            )
    ...
    def draw_confirm_reset_screen(self):
        ...
        confirm_text = self.font.render(
            "This will reset all high scores to 0", True, self.WHITE
        )
